...
///////// 新增
    ...
    [Keys.TEMPERATURE]: {str: '^\\circ\\mathrm{C} ', fn: WRITE},
    ...
    [Keys.SUPSETNEQQ]: {str: '\\supsetneqq', fn: WRITE},
    [Keys.NU]: {str: '\\nu', fn: WRITE},
    ...
    [Keys.OMEGA1]: {str: '\\omega', fn: WRITE},
    // 占位
...
class MathWrapper {
    ...
    _isNthRoot(node) {
        return node.blocks && node.blocks[0].jQ &&
            ...
            ||node.blocks[0].jQ.hasClass('mq-roman')
            ||node.blocks[0].jQ.hasClass('mq-supsub')
            ||node.blocks[0].jQ.hasClass('mq-numerator')
            );
    }
